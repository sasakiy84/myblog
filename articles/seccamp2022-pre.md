...
# セキュリティキャンプとは
公式によると「セキュリティ・キャンプとは、日本における将来の高度IT人材となり得る優れた人材の発掘と育成を目的とした独立行政法人情報処理推進機構(IPA)の事業の一つ」とのこと。
参加者目線でいうと、無料で一流の講師からセキュリティ関連の技術やセキュリティを学ぶための基礎になる技術を学ぶ機会を得られる場。また、おなじような分野に興味がある同年代の人たちと会える場でもある。一方で、将来的には学んだ技術を社会に役立てることが求められもする。
講師やテーマは毎回変わるが、今年度は以下のような講座があった。
...
それぞれの詳しい説明は[公式ページ](https://www.ipa.go.jp/jinzai/camp/2022/zenkoku2022_program_list.html#list_s-l1)を参照。
参加者は、上記のうち一つに所属し、事前学習と、 8 月にある 5 日間の講義に参加することになる。なお、今年度はオンラインで開催された。

# 知ったきっかけと応募した経緯
セキュリティキャンプの名前自体は、なんかの記事を読んで知っていた。5 月ごろに技術系の記事を集めた RSS で、セキュリティキャンプ募集の記事をみて、応募期間だということを知った。たしか、公式のセキュリティキャンプブログの記事だった気がする。
内容をみて webセキュリティクラスの講義内容に興味をもった。そこで課題を確認したところ、課題もある程度書けそうだと思った。他にもデータベースゼミなども面白そうだと思ってみていた。

# 選考課題を解いた感想
選考課題は、必答問題 3 問と選択問題 5 問で構成されていた。必答問題は、いままでの経験やモチベーションなどを答えるもの。選択問題は知識や調査結果を答えるもので、3問以上の回答が求められた。

## 選考課題からも学べる
選考課題を解いたあとに得た感想として、問題文の構成がとてもよいと感じた。参考にするページが問題文で示されていたため、事前知識が少なくても適切な資料を参照することができた。さらにいえば、どの資料を参考にするべきかという情報を得られたので、選考課題を終えた時点で得られるものがあったと感じた。

例として、Q4 で CSRF について答えたときをあげる。問題文には「現代の Web ブラウザ・Web アプリケーションフレームワークが備える仕組みを深く考慮しながら」とある。
自分はセキュリティといえば、開発者がどのようにコードを書くかが焦点だと思っていた。そのため、Web ブラウザの仕組みへの誘導文から、セキュリティの文脈でブラウザが果たす役割があることに気づくことができた。
そして、Q6 で HTML Living Standard が紹介されていたことで、ブラウザの仕様書ともいうべき HTML Living Standard や RFC を意識しながら解答することができた。

おそらく、選考課題を通じた学習は主催者側も意識していて、[「選考終了にあたり、竹迫講師主査から次回のセキュリティ・キャンプ全国大会を目指す方へのメッセージ」](https://www.ipa.go.jp/jinzai/camp/2022/zenkoku2022_vote.html) には、「応募課題に取り組んでみた姿勢、正解にたどり着くまでのプロセスは今後も非常に役に立つと思います。」と書かれている。このメッセージは、来年以降セキュリティキャンプに応募する人は、課題を解く前に一読すると、主催者側がどのように問題に答えてほしいかのイメージがつかめると思う。

## レベル感

選考課題を解き始めた時点では、セキュリティ関係の知識がほとんどない状態からのスタートだった。具体的には、CSRF がなにかもよくわかっていないような状態だった。なので、自分の知識に自信がなくても、興味をもった講義には、気軽に応募してみるとよいと思う。

# 選考課題の公開
セキュリティキャンプは、選考課題の解答を公開する文化があるらしい。応募中はそのことを知らず、自分がお世話になる機会はなかったが、来年度以降活用してくれる人がいるかもしれないので公開しておく。ようするに、この記事のメイン。
